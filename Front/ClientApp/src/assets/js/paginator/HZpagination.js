$(document).ready(function() {
        ...
        var HZperPage = 3, //number of results per page
            ...
            HZpaginationColorDefault = '#0a0b0c', //default color for the pagination numbers
            HZpaginationColorActive = '#ce3d0e', //color when page is clicked
        ...
        function paginationShow() {
            if ($("#" + HZpaginationId).children().length > 6) {
        ...
        $(".paginacaoValor:eq(0)").css("color", "" + HZpaginationColorActive).addClass("activePagination");
        var exibir = $("." + HZlines).slice(0, porPagina).show();
        $(".paginacaoValor").on("click", function() {
            $(".paginacaoValor").css("color", "" + HZpaginationColorDefault).removeClass("activePagination"), $(this).css("color", "" + HZpaginationColorActive).addClass("activePagination");
